...
def compute_coeff_classical_1(phi_classical_orbit, t_classical_orbit, Compression_Index,
                              Sigma_classical_average, tt, t1, N):
    """Compute Coefficient_classical_lambda_Fourier1"""
    
    # Construct the complex exponential signal using classical orbital phase
