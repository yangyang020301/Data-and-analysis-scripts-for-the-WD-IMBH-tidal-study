...
def compute_coeff_4(mino_time, tau_of_mino_time, upsilon_r_orbit, Compression_Index,
                    Sigma_average, tt, t1, N):
    """Compute Coefficient_tau_lambda_Fourier4"""
    ...
    # Check whether the time grid includes the 2π endpoint (common for periodic signals)
    ...
    # (often used to order modes from highest positive to most negative)
